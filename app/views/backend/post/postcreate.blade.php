...
@stop
@section('title')
    <title> Создать Новость Daemkredit.ru Meow! CMS</title>
...
@section('content')
    <div class="container">
        ...
        <div style="margin-top:50px;" class="mainbox col-md-8">
            ...
            {{Form::open(array('url' => route('postaddpost'), 'files' => true,'class' => 'form-horizontal'))}}
            {{Form::token();}}
            ...
            <div class="input-group">
                ...
                <select multiple class="form-control" name="rubric[]">
